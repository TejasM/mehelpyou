...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request.title'
        db.alter_column(u'request_request', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Request.title'
        db.alter_column(u'request_request', 'title', self.gf('django.db.models.fields.CharField')(max_length=15))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Response.collected'
        db.delete_column(u'response_response', 'collected')


    def backwards(self, orm):
        # Adding field 'Response.collected'
        db.add_column(u'response_response', 'collected',

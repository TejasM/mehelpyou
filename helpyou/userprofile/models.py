...
class UserProfile(models.Model):
    ...
    educations = models.CharField(max_length=10000, default='')
    num_connections = models.IntegerField(default=0)
    num_recommenders = models.IntegerField(default=0)
    recommendations_received = models.CharField(max_length=10000, default='', null=True)
    groups = models.CharField(max_length=10000, default='')

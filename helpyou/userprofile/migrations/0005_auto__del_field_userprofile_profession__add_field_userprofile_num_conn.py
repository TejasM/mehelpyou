...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.num_connections'
        db.add_column(u'userprofile_userprofile', 'num_connections',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.num_connections'
        db.delete_column(u'userprofile_userprofile', 'num_connections')

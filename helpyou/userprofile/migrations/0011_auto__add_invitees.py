...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Invitees'
        db.create_table(u'userprofile_invitees', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_address', self.gf('django.db.models.fields.EmailField')(default='', max_length=75)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=500)),
            ('uid', self.gf('django.db.models.fields.CharField')(default='', max_length=500)),
            ('user_from', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['userprofile.UserProfile'], null=True)),
        ))
        db.send_create_signal(u'userprofile', ['Invitees'])


    def backwards(self, orm):
        # Deleting model 'Invitees'
        db.delete_table(u'userprofile_invitees')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field connections on 'UserProfile'
        db.create_table(u'userprofile_userprofile_connections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'userprofile.userprofile'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'userprofile_userprofile_connections', ['userprofile_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field connections on 'UserProfile'
        db.delete_table('userprofile_userprofile_connections')

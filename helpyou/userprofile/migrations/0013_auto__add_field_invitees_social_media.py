...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitees.social_media'
        db.add_column(u'userprofile_invitees', 'social_media',
                      self.gf('django.db.models.fields.CharField')(default='linkedin-oauth2', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitees.social_media'
        db.delete_column(u'userprofile_invitees', 'social_media')

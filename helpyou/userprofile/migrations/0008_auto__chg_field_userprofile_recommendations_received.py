...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.recommendations_received'
        db.alter_column(u'userprofile_userprofile', 'recommendations_received', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'recommendations_received': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1000', 'null': 'True'}),

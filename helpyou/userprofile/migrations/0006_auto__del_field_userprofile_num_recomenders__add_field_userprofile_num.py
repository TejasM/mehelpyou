...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.num_recommenders'
        db.add_column(u'userprofile_userprofile', 'num_recommenders',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.num_recommenders'
        db.delete_column(u'userprofile_userprofile', 'num_recommenders')

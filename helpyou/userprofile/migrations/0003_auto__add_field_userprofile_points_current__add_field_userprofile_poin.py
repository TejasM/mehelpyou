...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.points_collected'
        db.add_column(u'userprofile_userprofile', 'points_collected',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.paypal_email'
        db.add_column(u'userprofile_userprofile', 'paypal_email',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.points_collected'
        db.delete_column(u'userprofile_userprofile', 'points_collected')

        # Deleting field 'UserProfile.paypal_email'
        db.delete_column(u'userprofile_userprofile', 'paypal_email')
    ...
    models = {
        ...
        u'userprofile.userprofile': {
            ...
            'points_collected': ('django.db.models.fields.FloatField', [], {'default': '0'}),

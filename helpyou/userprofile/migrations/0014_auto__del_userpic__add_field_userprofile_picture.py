...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'UserPic'
        db.delete_table(u'userprofile_userpic')

        # Adding field 'UserProfile.picture'
        db.add_column(u'userprofile_userprofile', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='default-avatar.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'UserPic'
        db.create_table(u'userprofile_userpic', (
            ('image', self.gf('django.db.models.fields.files.ImageField')(default='None', max_length=100)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_info', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'userprofile', ['UserPic'])

        # Deleting field 'UserProfile.picture'
        db.delete_column(u'userprofile_userprofile', 'picture')
    ...
    models = {
        ...
        u'userprofile.invitees': {
            ...
            'social_media': ('django.db.models.fields.CharField', [], {'default': "'linkedin-oauth2'", 'max_length': '100'}),
        ...
        u'userprofile.userprofile': {
            ...
            'picture': ('django.db.models.fields.files.ImageField', [], {'default': "'default-avatar.png'", 'max_length': '100'}),

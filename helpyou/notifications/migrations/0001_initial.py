...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notifications_notification', (
            ...
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['response.Response'])),
        ))
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['response.Response']"}),
